...
A Machine Learning powered Smap Email Classifier built using **TF-IDF, Multinomial Naive Bayes**, deploed as a full-stack web application using **FastAPI, Jinja and Bootstrap 5**.
